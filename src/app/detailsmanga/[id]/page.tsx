...
import detailsManga from "@/app/api/detailsManga/route";
import mangaCharacters from "@/app/api/mangaCharacters/route";
...
export default function DetailsManga() {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center pt-[78px]">
            {isLoading ? (
                <p>Loading...</p>
            ) : (
                <div className="container px-1 lg:px-0">
                    ...
                    <div className="w-full grid lg:grid-cols-6 px-4 py-2 gap-8">
                        <div className="lg:col-span-1 text-sm p-2 flex flex-col gap-2 bg-secondary rounded-lg shadow-md h-full lg:h-[1000px]">
                            <div>
                                <p>Airing</p>
